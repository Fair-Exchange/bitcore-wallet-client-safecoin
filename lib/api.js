...
//    xpriv.coin = xpriv.toHDPrivateKey();
  ...
  function testLiveKeys(coin) {
    ...
    if (coin && coin == 'btc') {
      ...
      BitcoreBtc = require('bitcore-lib-safe-mini');
...
API.prototype.getBalanceFromPrivateKey = function(privateKey, coin, cb) {
  ...
  if (coin == 'btc') {
    ...
    CorePrvK = require('bitcore-lib-safe-mini').PrivateKey;
  } else if (coin == 'btcz') {
...
//  var bitcore; // = Bitcore_[txp.coin];
  ...
  if (txp.coin == 'btc') {
    ...
    CoreHDPub = require('bitcore-lib-safe-mini').HDPublicKey;
    CoreCrSig = require('bitcore-lib-safe-mini').crypto.Signature; 
