...
API.prototype.getFeeLevels = function(coin, network, cb) {
  ...
  $.checkArgument(coin || _.includes(['btc', 'bch', 'safe', 'btcz', 'zcl', 'anon', 'zel', 'zen', 'rvn', 'ltc'], coin));
...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var coin = opts.coin || 'safe';
  if (!_.includes(['btc', 'bch', 'safe', 'btcz', 'zcl', 'anon', 'zel', 'zen', 'rvn', 'ltc'], coin)) return cb(new Error('Invalid coin11'));
...
API.prototype.joinWallet = function(secret, copayerName, opts, cb) {
  ...
  var coin = opts.coin || 'safe';
  if (!_.includes(['btc', 'bch', 'safe', 'btcz', 'zcl', 'anon', 'zel', 'zen', 'rvn', 'ltc'], coin)) return cb(new Error('Invalid coin22'));
...
API.prototype.getBalance = function(opts, cb) {
  ...
  if (opts.coin) {
    if (!_.includes(['btc', 'bch', 'safe', 'btcz', 'zcl', 'anon', 'zel', 'zen', 'rvn', 'ltc'], opts.coin)) return cb(new Error('Invalid coin33'));
...
API.signTxProposalFromAirGapped = function(key, txp, unencryptedPkr, m, n, opts) {
  ...
  var coin = opts.coin || 'safe';
  if (!_.includes(['btc', 'bch', 'safe', 'btcz', 'zcl', 'anon', 'zel', 'zen', 'rvn', 'ltc'], coin)) return cb(new Error('Invalid coin44'));
