...
//    xpriv.coin = xpriv.toHDPrivateKey();
  ...
  function testLiveKeys(coin) {
    ...
    if (coin && coin == 'btc') {
      ...
      BitcoreBtc = require('bitcore-lib-zel-mini');
...
API.prototype.getBalanceFromPrivateKey = function(privateKey, coin, cb) {
  ...
  if (coin == 'btc') {
    ...
    CorePrvK = require('bitcore-lib-zel-mini').PrivateKey;
  } else if (coin == 'zen') {
...
//  var bitcore; // = Bitcore_[txp.coin];
  ...
  if (txp.coin == 'btc') {
    ...
    CoreHDPub = require('bitcore-lib-zel-mini').HDPublicKey;
    CoreCrSig = require('bitcore-lib-zel-mini').crypto.Signature; 
